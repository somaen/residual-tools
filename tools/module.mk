...
tools/patchex/patchex$(EXEEXT): tools/patchex/patchex.o tools/patchex/cabd.o tools/patchex/packfile.o
	$(MKDIR) tools/patchex/$(DEPDIR)
	$(CXX) $(CFLAGS) tools/patchex/cabd.o tools/patchex/packfile.o -Wall -lz -o $@ $<
